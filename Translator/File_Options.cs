...
namespace Translator
{
    ...
    public partial class File_Options : Form
    {
        ...
        private string[] FORMAT_RULES = { "LEADING_ZEROES", "LEADING_LETTER", "DATABASE_INFO", "FIRST_LINE", "LAST_LINE", "REUSE_VALUES", "IGNORE_FORMATTING" };
...

        {
            ...
            textBox1.Text = Get_Rule_Parameter("REUSE_VALUES", 2) == "" ? "99999" : Get_Rule_Parameter("REUSE_VALUES", 2);
            value.Text = Get_Rule_Parameter("LEADING_LETTER", 2) == "" ? "" : Get_Rule_Parameter("LEADING_LETTER", 2);
            ...
            ignoreFormatting.Checked = Get_Rule_Parameter("IGNORE_FORMATTING", 2) == "1";
            try
            {
                ...
                db_conn_str.Text = Get_Rule_Parameter("DATABASE_INFO", 2) == "" ? "(Example: 'Driver={SQL Server};Server=10.0.0.8'" : enc_obj.Decrypt(Get_Rule_Parameter("DATABASE_INFO", 2).Split(new string[] { "†" }, StringSplitOptions.None)[3]);
            }
            catch
            {
                db_name.Text = "(Example: 'dbo')";
                db_conn_str.Text = "(Example: 'Driver={SQL Server};Server=10.0.0.8')";
            }
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            _parent._GLOBAL_DELETE_FORMAT_RULE("REUSE_VALUES");
            _parent._GLOBAL_DELETE_FORMAT_RULE("IGNORE_FORMATTING");
            Modify_Rule("LEADING_ZEROES", count_box.Text);
            Modify_Rule("LEADING_LETTER", value.Text.ToLower() == "none" ? "" : value.Text);
            Modify_Rule("FIRST_LINE", first_line_box.Text);
            Modify_Rule("LAST_LINE", last_line_box.Text);
            Modify_Rule("LAST_LINE", last_line_box.Text);
            Modify_Rule("REUSE_VALUES", textBox1.Text);
            Modify_Rule("IGNORE_FORMATTING", ignoreFormatting.Checked ? "1" : "0");
