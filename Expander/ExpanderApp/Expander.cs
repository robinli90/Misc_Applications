...
namespace ExpanderApp
{
    ...
    {
        public static Label CreateLabelHeader(Expander expander, string text, Color backColor, Color labelColor, Image collapsedImage = null, Image expandedImage = null, int height = 25, Font font = null)
        {
            if (labelColor == null) labelColor = Color.Black;
            Label headerLabel = new Label();
            headerLabel.Text = text;
            headerLabel.ForeColor = labelColor;
